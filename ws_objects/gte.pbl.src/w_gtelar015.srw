$PBExportHeader$w_gtelar015.srw
forward
global type w_gtelar015 from window
end type
type rb_2 from radiobutton within w_gtelar015
end type
type rb_1 from radiobutton within w_gtelar015
end type
type ddlb_3 from dropdownlistbox within w_gtelar015
end type
type st_1 from statictext within w_gtelar015
end type
type st_3 from statictext within w_gtelar015
end type
type em_1 from editmask within w_gtelar015
end type
type cb_1 from commandbutton within w_gtelar015
end type
type cb_2 from commandbutton within w_gtelar015
end type
type gb_1 from groupbox within w_gtelar015
end type
type dw_1 from datawindow within w_gtelar015
end type
type dw_2 from datawindow within w_gtelar015
end type
end forward
...
global w_gtelar015 w_gtelar015
...
if rb_1.checked then
	...
	dw_1.hide()
	dw_2.show()
	dw_2.retrieve(em_1.text,long(ddlb_3.text))
...
integer width = 4453
integer height = 2184
string dataobject = "dw_gtelar015"
...
integer height = 2184
integer taborder = 40
string dataobject = "dw_gtelar015s"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
