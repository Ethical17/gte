$PBExportHeader$w_gtebgf006.srw
forward
global type w_gtebgf006 from window
end type
type st_1 from statictext within w_gtebgf006
end type
type em_1 from editmask within w_gtebgf006
end type
type cb_4 from commandbutton within w_gtebgf006
end type
type cb_3 from commandbutton within w_gtebgf006
end type
type cb_2 from commandbutton within w_gtebgf006
end type
type cb_1 from commandbutton within w_gtebgf006
end type
type dw_1 from datawindow within w_gtebgf006
end type
end forward
...
string title = "(w_gtebgf006)Yearly Area Budget"
...
global w_gtebgf006 w_gtebgf006
...
public function integer wf_check_duplicate_rec (integer fl_year)
end prototypes
...
public function integer wf_check_fillcol (integer fl_row);if dw_1.rowcount() > 0 and fl_row > 0 then
	if (isnull(dw_1.getitemnumber(fl_row,'year')) or  dw_1.getitemnumber(fl_row,'year')=0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mt_area')) or  dw_1.getitemnumber(fl_row,'mt_area') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'yt_area')) or  dw_1.getitemnumber(fl_row,'yt_area') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'zt_area')) or  dw_1.getitemnumber(fl_row,'zt_area') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'up_area')) or  dw_1.getitemnumber(fl_row,'up_area') < 0) then
...
public function integer wf_check_duplicate_rec (integer fl_year);long fl_row,ll_year1
...
if dw_1.rowcount() > 1 then
	for fl_row = 1 to (dw_1.rowcount())
		...
		ll_year1 = dw_1.getitemnumber(fl_row,'year')
...
IF (isnull(dw_1.getitemnumber(dw_1.rowcount(),'year')) or dw_1.getitemnumber(dw_1.rowcount(),'year')=0) THEN
...
event clicked;if cb_2.text = "&Query" then
	...
	dw_1.reset()
	dw_1.settaborder('mt_area',10)
	lb_query = true
	dw_1.modify("datawindow.queryclear= yes")
	dw_1.Object.datawindow.querymode= 'yes'
	dw_1.SetFocus ()
	dw_1.setcolumn('mt_area')
	cb_2.text = "&Run"
	cb_1.enabled = false
	cb_3.enabled = false
else
...
if dw_1.rowcount() = 0 then
	...
	dw_1.setfocus()
	dw_1.setitem(dw_1.getrow(),'year',ll_year)
	//dw_1.setitem(dw_1.getrow(),'eachead_id',ls_eachead_id)
	//dw_1.setitem(dw_1.getrow(),'eacsubhead_id',ls_eacsubhead_id)
	dw_1.setitem(dw_1.getrow(),'yt_entry_by',gs_user)
	dw_1.setitem(dw_1.getrow(),'yt_entry_dt',datetime(today()))
	dw_1.setcolumn('mt_area')
else
...
if dwo.name = 'year'  then
    ...
    if  wf_check_duplicate_rec(ll_year) = -1 then return 1 
end if
