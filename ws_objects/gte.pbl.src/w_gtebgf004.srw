$PBExportHeader$w_gtebgf004.srw
forward
global type w_gtebgf004 from window
end type
type st_1 from statictext within w_gtebgf004
end type
type em_1 from editmask within w_gtebgf004
end type
type cb_4 from commandbutton within w_gtebgf004
end type
type cb_3 from commandbutton within w_gtebgf004
end type
type cb_2 from commandbutton within w_gtebgf004
end type
type cb_1 from commandbutton within w_gtebgf004
end type
type dw_1 from datawindow within w_gtebgf004
end type
end forward
...
string title = "(w_gtebgf004)Others Budget"
...
global w_gtebgf004 w_gtebgf004
...
public function integer wf_check_fillcol (integer fl_row);if dw_1.rowcount() > 0 and fl_row > 0 then
	if (isnull(dw_1.getitemnumber(fl_row,'mob_year')) or  dw_1.getitemnumber(fl_row,'mob_year')=0 or &
		 isnull(dw_1.getitemstring(fl_row,'eacsubhead_id')) or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_janprice')) or  dw_1.getitemnumber(fl_row,'mob_janprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_febprice')) or  dw_1.getitemnumber(fl_row,'mob_febprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_marprice')) or  dw_1.getitemnumber(fl_row,'mob_marprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_aprprice')) or  dw_1.getitemnumber(fl_row,'mob_aprprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_mayprice')) or  dw_1.getitemnumber(fl_row,'mob_mayprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_junprice')) or  dw_1.getitemnumber(fl_row,'mob_junprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_julprice')) or  dw_1.getitemnumber(fl_row,'mob_julprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_augprice')) or  dw_1.getitemnumber(fl_row,'mob_augprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_sepprice')) or  dw_1.getitemnumber(fl_row,'mob_sepprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_octprice')) or  dw_1.getitemnumber(fl_row,'mob_octprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_novprice')) or  dw_1.getitemnumber(fl_row,'mob_novprice') < 0 or &
		 isnull(dw_1.getitemnumber(fl_row,'mob_decprice')) or dw_1.getitemnumber(fl_row,'mob_decprice') < 0) then
...
if dw_1.rowcount() > 1 then
	for fl_row = 1 to (dw_1.rowcount())
		...
		ll_year1 = dw_1.getitemnumber(fl_row,'mob_year')
...
dw_1.GetChild ("eacsubhead_id", idw_subexp_oth)
...
IF (isnull(dw_1.getitemnumber(dw_1.rowcount(),'mob_year')) or dw_1.getitemnumber(dw_1.rowcount(),'mob_year')=0) THEN
...
if dw_1.rowcount() = 0 then
	...
	dw_1.setfocus()
	dw_1.setitem(dw_1.getrow(),'mob_year',ll_year)
	dw_1.setitem(dw_1.getrow(),'eachead_id',ls_eachead_id)
	dw_1.setitem(dw_1.getrow(),'eacsubhead_id',ls_eacsubhead_id)
	dw_1.setitem(dw_1.getrow(),'mob_entry_by',gs_user)
	dw_1.setitem(dw_1.getrow(),'mob_entry_dt',datetime(today()))
	dw_1.setcolumn('eachead_id')
else
...
event key_down;if lb_query = false then
 if lb_neworder = true then	
	...
	if newrow = dw_1.rowcount() and dw_1.rowcount() > 1  then
		dw_1.setitem(dw_1.getrow(),'mob_year',ll_year)	
		dw_1.setitem(dw_1.getrow(),'mob_entry_by',gs_user)
		dw_1.setitem(dw_1.getrow(),'mob_entry_by',datetime(today()))
		dw_1.setcolumn('eachead_id')
	end if
 end if
end if
