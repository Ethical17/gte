$PBExportHeader$w_gteflr003.srw
forward
global type w_gteflr003 from window
end type
type st_3 from statictext within w_gteflr003
end type
type ddlb_1 from dropdownlistbox within w_gteflr003
end type
type cb_2 from commandbutton within w_gteflr003
end type
type cb_1 from commandbutton within w_gteflr003
end type
type st_2 from statictext within w_gteflr003
end type
type dp_2 from datepicker within w_gteflr003
end type
type dp_1 from datepicker within w_gteflr003
end type
type st_1 from statictext within w_gteflr003
end type
type rb_2 from radiobutton within w_gteflr003
end type
type rb_1 from radiobutton within w_gteflr003
end type
type dw_1 from datawindow within w_gteflr003
end type
type gb_1 from groupbox within w_gteflr003
end type
end forward
...
global w_gteflr003 w_gteflr003
...
datetime value = DateTime(Date("2012-12-04"), Time("09:26:01.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
integer width = 4507
integer height = 2056
string dataobject = "dw_gteflr003"
