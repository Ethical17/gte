$PBExportHeader$w_gteprof017.srw
forward
global type w_gteprof017 from window
end type
type cb_4 from commandbutton within w_gteprof017
end type
type cb_3 from commandbutton within w_gteprof017
end type
type cb_2 from commandbutton within w_gteprof017
end type
type cb_1 from commandbutton within w_gteprof017
end type
type dw_1 from datawindow within w_gteprof017
end type
end forward
...
string title = "(w_gteprof017) Packed Tea Receive"
...
global w_gteprof017 w_gteprof017
...
if dw_1.rowcount() = 0 then
	...
	dw_1.setitem(dw_1.getrow(),'pt_trantype','R')
...
integer height = 2052
integer taborder = 30
string dataobject = "dw_gteprof017"
...
event itemchanged;if lb_query = false then
	...
	if dwo.name = 'pt_unit_to' then
		...
		if ls_unitto = ls_unitfrom then
			messagebox('Warning!','Unit From & Unit To Should Not Be Same, Please Check !!!')
			return 1
		end if
	end if
