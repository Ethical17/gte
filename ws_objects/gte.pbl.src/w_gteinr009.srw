$PBExportHeader$w_gteinr009.srw
forward
global type w_gteinr009 from window
end type
type dp_2 from datepicker within w_gteinr009
end type
type dp_1 from datepicker within w_gteinr009
end type
type st_2 from statictext within w_gteinr009
end type
type st_1 from statictext within w_gteinr009
end type
type cb_2 from commandbutton within w_gteinr009
end type
type cb_4 from commandbutton within w_gteinr009
end type
type dw_1 from datawindow within w_gteinr009
end type
end forward
...
string title = "(W_gteinr009) Entry Tax"
...
global w_gteinr009 w_gteinr009
...
datetime value = DateTime(Date("2012-05-20"), Time("22:44:23.000000"))
integer textsize = -9
...
integer height = 2236
integer taborder = 60
string dataobject = "dw_gteinr009"
