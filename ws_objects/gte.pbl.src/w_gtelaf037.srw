$PBExportHeader$w_gtelaf037.srw
forward
global type w_gtelaf037 from window
end type
type cb_4 from commandbutton within w_gtelaf037
end type
type cb_3 from commandbutton within w_gtelaf037
end type
type cb_2 from commandbutton within w_gtelaf037
end type
type cb_1 from commandbutton within w_gtelaf037
end type
type dw_1 from datawindow within w_gtelaf037
end type
end forward
...
string title = "(w_gtelaf037) Kamjari Incentive"
...
global w_gtelaf037 w_gtelaf037
...
if dw_1.rowcount() = 0 then
	...
	dw_1.setfocus()
	dw_1.setitem(dw_1.getrow(),'inc_rec_type','K')
...
integer height = 2052
integer taborder = 30
string dataobject = "dw_gtelaf037"
...
event key_down;if lb_query = false then
 if lb_neworder = true then	
	...
	if newrow = dw_1.rowcount() and dw_1.rowcount() > 1  then
		dw_1.setitem(newrow,'inc_rec_type','K')
