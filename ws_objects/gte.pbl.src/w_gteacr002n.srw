$PBExportHeader$w_gteacr002n.srw
forward
global type w_gteacr002n from window
end type
type dp_1 from datepicker within w_gteacr002n
end type
type dp_2 from datepicker within w_gteacr002n
end type
type ddlb_1 from dropdownlistbox within w_gteacr002n
end type
type em_1 from editmask within w_gteacr002n
end type
type cb_2 from commandbutton within w_gteacr002n
end type
type cb_1 from commandbutton within w_gteacr002n
end type
type st_5 from statictext within w_gteacr002n
end type
type st_4 from statictext within w_gteacr002n
end type
type st_2 from statictext within w_gteacr002n
end type
type st_1 from statictext within w_gteacr002n
end type
type dw_1 from datawindow within w_gteacr002n
end type
end forward
...
string title = "(W_gteacr002n) Cash Book"
...
global w_gteacr002n w_gteacr002n
...
datetime value = DateTime(Date("2026-06-24"), Time("15:54:48.000000"))
integer textsize = -9
...
integer width = 3822
integer height = 1980
string dataobject = "dw_gteacr002n"
