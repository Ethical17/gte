$PBExportHeader$w_gtelar048_mr.srw
forward
global type w_gtelar048_mr from window
end type
type rb_2 from radiobutton within w_gtelar048_mr
end type
type rb_1 from radiobutton within w_gtelar048_mr
end type
type ddlb_3 from dropdownlistbox within w_gtelar048_mr
end type
type st_3 from statictext within w_gtelar048_mr
end type
type cb_3 from commandbutton within w_gtelar048_mr
end type
type ddlb_2 from dropdownlistbox within w_gtelar048_mr
end type
type st_1 from statictext within w_gtelar048_mr
end type
type cb_1 from commandbutton within w_gtelar048_mr
end type
type cb_2 from commandbutton within w_gtelar048_mr
end type
type st_2 from statictext within w_gtelar048_mr
end type
type ddlb_1 from dropdownlistbox within w_gtelar048_mr
end type
type dw_1 from datawindow within w_gtelar048_mr
end type
type gb_1 from groupbox within w_gtelar048_mr
end type
end forward
...
global w_gtelar048_mr w_gtelar048_mr

type variables
long ll_pbno, ll_srlno
string ls_temp, ls_dt,ls_labid,ls_measure,ls_measure1,ls_first_read,ls_old_labour, ls_type, ls_bank, ls_emptype, ls_ind
datetime ld_dt
...
long backcolor = 67108864
string text = "Only having account number"
...
if isnull(ddlb_1.text) or len(ddlb_1.text) = 0 then
	...
	dw_1.dataobject = 'dw_gtelar048_mr_bl'
	dw_1.settransobject(sqlca)
	dw_1.retrieve(ls_fr_dt,ls_bank)
	if dw_1.rowcount() > 0 then;
		...
		dw_1.SaveAs(ls_newpath+"LUXMI"+string(today(),"ddmmyy")+string(ll_srlno)+".xls",Excel8!,false)		
	end if		
...
//	dw_1.dataobject = 'dw_gtelar048_mr'
	dw_1.settransobject(sqlca)
	dw_1.retrieve(ls_fr_dt,ls_bank,gs_garden_snm,ls_emptype,ls_ind)
//end if
