$PBExportHeader$w_gtelar024.srw
forward
global type w_gtelar024 from window
end type
type st_1 from statictext within w_gtelar024
end type
type cb_1 from commandbutton within w_gtelar024
end type
type cb_2 from commandbutton within w_gtelar024
end type
type st_2 from statictext within w_gtelar024
end type
type dw_1 from datawindow within w_gtelar024
end type
type ddlb_1 from dropdownlistbox within w_gtelar024
end type
type ddlb_2 from dropdownlistbox within w_gtelar024
end type
end forward
...
global w_gtelar024 w_gtelar024
...
dw_1.retrieve(left(ddlb_1.text,10),ddlb_2.text,ls_temp)
...
integer width = 4421
integer height = 2056
string dataobject = "dw_gtelar024"
