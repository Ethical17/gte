$PBExportHeader$w_gteacr005.srw
forward
global type w_gteacr005 from window
end type
type cb_3 from commandbutton within w_gteacr005
end type
type ddlb_2 from dropdownlistbox within w_gteacr005
end type
type st_4 from statictext within w_gteacr005
end type
type st_6 from statictext within w_gteacr005
end type
type dp_1 from datepicker within w_gteacr005
end type
type st_1 from statictext within w_gteacr005
end type
type dp_2 from datepicker within w_gteacr005
end type
type ddlb_1 from dropdownlistbox within w_gteacr005
end type
type st_3 from statictext within w_gteacr005
end type
type st_2 from statictext within w_gteacr005
end type
type em_3 from editmask within w_gteacr005
end type
type cb_2 from commandbutton within w_gteacr005
end type
type cb_1 from commandbutton within w_gteacr005
end type
type dw_1 from datawindow within w_gteacr005
end type
end forward
...
global w_gteacr005 w_gteacr005
...
select distinct initcap(ACLEDGER_NAME)||'('||ACLEDGER_ID||')' from fb_acledger order by 1;
...
datetime value = DateTime(Date("2024-08-08"), Time("09:58:24.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
event selectionchanged;ddlb_2.text = left(right(ddlb_1.text,8),7)
end event
...
if isnull(ddlb_2.text) or len(ddlb_2.text) <1 then 
	messagebox('Error :','Please Select a Valid Ledger Code Should be Enter') 
end if
...
integer width = 3781
integer height = 2228
string dataobject = "dw_gteacr005"
