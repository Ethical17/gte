$PBExportHeader$w_gteflr015n.srw
forward
global type w_gteflr015n from window
end type
type ddlb_1 from dropdownlistbox within w_gteflr015n
end type
type st_3 from statictext within w_gteflr015n
end type
type cb_2 from commandbutton within w_gteflr015n
end type
type cb_1 from commandbutton within w_gteflr015n
end type
type st_2 from statictext within w_gteflr015n
end type
type dp_2 from datepicker within w_gteflr015n
end type
type dp_1 from datepicker within w_gteflr015n
end type
type st_1 from statictext within w_gteflr015n
end type
type rb_2 from radiobutton within w_gteflr015n
end type
type rb_1 from radiobutton within w_gteflr015n
end type
type gb_1 from groupbox within w_gteflr015n
end type
type dw_1 from datawindow within w_gteflr015n
end type
type dw_2 from datawindow within w_gteflr015n
end type
end forward
...
global w_gteflr015n w_gteflr015n
...
if ll_user_level=1 then
	dw_1.dataobject='dw_gteflr015n'
	dw_1.settransobject(sqlca)	
elseif ll_user_level=2 then	
	dw_1.dataobject='dw_gteflr015np'
	dw_1.settransobject(sqlca)
else
...
datetime value = DateTime(Date("2024-07-26"), Time("08:17:57.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
integer width = 3643
integer height = 1960
string dataobject = "dw_gteflr015n"
...
integer height = 1960
integer taborder = 40
string dataobject = "dw_gteflr015np"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
boolean livescroll = true
