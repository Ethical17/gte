$PBExportHeader$w_gteinr004.srw
forward
global type w_gteinr004 from window
end type
type cbx_1 from checkbox within w_gteinr004
end type
type dp_1 from datepicker within w_gteinr004
end type
type dp_2 from datepicker within w_gteinr004
end type
type st_2 from statictext within w_gteinr004
end type
type st_1 from statictext within w_gteinr004
end type
type cb_2 from commandbutton within w_gteinr004
end type
type cb_4 from commandbutton within w_gteinr004
end type
type dw_1 from datawindow within w_gteinr004
end type
type dw_2 from datawindow within w_gteinr004
end type
end forward
...
string title = "(W_gteinr004) Store Category Wise Stock"
...
global w_gteinr004 w_gteinr004
...
datetime value = DateTime(Date("2024-09-14"), Time("09:40:56.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
//if rb_2.checked then
	...
	dw_1.retrieve(ls_frym,ls_toym,gs_storeid, gs_user,ls_nppc)
...
integer height = 1936
integer taborder = 50
string dataobject = "dw_gteinr004"
...
if row > 0 then
	...
	ls_frym =dp_1.text
     ls_toym =dp_2.text
	dw_2.retrieve(ls_frym,ls_toym,dw_1.getitemstring(row,'SPC_ID'),gs_storeid, gs_user,ls_nppc)
	dw_1.visible = false
end if
...
integer height = 1936
integer taborder = 60
string dataobject = "dw_gteinr004a"
