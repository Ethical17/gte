$PBExportHeader$w_gtepror002.srw
forward
global type w_gtepror002 from window
end type
type st_2 from statictext within w_gtepror002
end type
type dp_2 from datepicker within w_gtepror002
end type
type dp_1 from datepicker within w_gtepror002
end type
type rb_2 from radiobutton within w_gtepror002
end type
type rb_1 from radiobutton within w_gtepror002
end type
type st_1 from statictext within w_gtepror002
end type
type cb_1 from commandbutton within w_gtepror002
end type
type cb_2 from commandbutton within w_gtepror002
end type
type dw_1 from datawindow within w_gtepror002
end type
type gb_1 from groupbox within w_gtepror002
end type
end forward
...
string title = "(Gtepror002) - Grid & Genset Consumption"
...
global w_gtepror002 w_gtepror002
...
datetime value = DateTime(Date("2012-05-20"), Time("23:04:45.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
integer width = 4357
integer height = 2028
string dataobject = "dw_gtepror002"
