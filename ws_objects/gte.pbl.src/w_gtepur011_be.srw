$PBExportHeader$w_gtepur011_be.srw
forward
global type w_gtepur011_be from window
end type
type dp_1 from datepicker within w_gtepur011_be
end type
type dp_2 from datepicker within w_gtepur011_be
end type
type st_2 from statictext within w_gtepur011_be
end type
type st_1 from statictext within w_gtepur011_be
end type
type cb_2 from commandbutton within w_gtepur011_be
end type
type cb_4 from commandbutton within w_gtepur011_be
end type
type dw_1 from datawindow within w_gtepur011_be
end type
type dw_2 from datawindow within w_gtepur011_be
end type
end forward
...
string title = "(W_gteinr011) Store Category HO Purchase"
...
global w_gtepur011_be w_gtepur011_be
...
datetime value = DateTime(Date("2019-01-28"), Time("14:48:41.000000"))
integer textsize = -9
...
integer height = 1936
integer taborder = 50
string dataobject = "dw_gtepur011_be"
...
integer height = 1936
integer taborder = 60
string dataobject = "dw_gtepur011a_be"
boolean vscrollbar = true
end type
