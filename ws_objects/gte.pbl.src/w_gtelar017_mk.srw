$PBExportHeader$w_gtelar017_mk.srw
forward
global type w_gtelar017_mk from window
end type
type rb_4 from radiobutton within w_gtelar017_mk
end type
type rb_3 from radiobutton within w_gtelar017_mk
end type
type rb_2 from radiobutton within w_gtelar017_mk
end type
type rb_1 from radiobutton within w_gtelar017_mk
end type
type st_1 from statictext within w_gtelar017_mk
end type
type ddlb_3 from dropdownlistbox within w_gtelar017_mk
end type
type ddlb_2 from dropdownlistbox within w_gtelar017_mk
end type
type ddlb_1 from dropdownlistbox within w_gtelar017_mk
end type
type cb_2 from commandbutton within w_gtelar017_mk
end type
type st_2 from statictext within w_gtelar017_mk
end type
type st_3 from statictext within w_gtelar017_mk
end type
type cb_1 from commandbutton within w_gtelar017_mk
end type
type gb_1 from groupbox within w_gtelar017_mk
end type
type dw_4 from datawindow within w_gtelar017_mk
end type
type dw_1 from datawindow within w_gtelar017_mk
end type
type dw_2 from datawindow within w_gtelar017_mk
end type
type dw_3 from datawindow within w_gtelar017_mk
end type
end forward
...
global w_gtelar017_mk w_gtelar017_mk
...
integer taborder = 50
string title = "none"
string dataobject = "dw_gtelar017bf_mk"
