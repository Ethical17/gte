$PBExportHeader$w_gtelar007_be.srw
forward
global type w_gtelar007_be from window
end type
type rb_1 from radiobutton within w_gtelar007_be
end type
type dw_2 from datawindow within w_gtelar007_be
end type
type st_1 from statictext within w_gtelar007_be
end type
type cb_1 from commandbutton within w_gtelar007_be
end type
type cb_2 from commandbutton within w_gtelar007_be
end type
type st_2 from statictext within w_gtelar007_be
end type
type ddlb_1 from dropdownlistbox within w_gtelar007_be
end type
type ddlb_2 from dropdownlistbox within w_gtelar007_be
end type
type dw_1 from datawindow within w_gtelar007_be
end type
end forward
...
string title = "(Gtelar007be) - Wages Summary"
...
global w_gtelar007_be w_gtelar007_be
...
integer height = 2200
integer taborder = 30
string dataobject = "dw_gtelar007b_be"
...
if rb_1.checked then
	...
	dw_2.retrieve(left(ddlb_1.text,10),ddlb_2.text,ls_temp,gs_garden_snm,gs_garden_state)
	...
	dw_1.retrieve(left(ddlb_1.text,10),ddlb_2.text,ls_temp,gs_garden_snm,gs_garden_state)
...
integer width = 4421
integer height = 2056
string dataobject = "dw_gtelar007_be"
boolean hscrollbar = true
boolean vscrollbar = true
boolean resizable = true
boolean livescroll = true
