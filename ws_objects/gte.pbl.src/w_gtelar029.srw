$PBExportHeader$w_gtelar029.srw
forward
global type w_gtelar029 from window
end type
type cbx_1 from checkbox within w_gtelar029
end type
type dp_2 from datepicker within w_gtelar029
end type
type dp_1 from datepicker within w_gtelar029
end type
type ddlb_2 from dropdownlistbox within w_gtelar029
end type
type st_3 from statictext within w_gtelar029
end type
type st_1 from statictext within w_gtelar029
end type
type cb_1 from commandbutton within w_gtelar029
end type
type cb_2 from commandbutton within w_gtelar029
end type
type st_2 from statictext within w_gtelar029
end type
type dw_1 from datawindow within w_gtelar029
end type
end forward
...
string title = "(Gtelar029) - Labour CBKSSS/LWF"
...
global w_gtelar029 w_gtelar029
...
select distinct ls_id
 ...
 where  b.LABOUR_ID = a.emp_ID order by 1;
...
datetime value = DateTime(Date("2012-05-20"), Time("23:01:28.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
dw_1.retrieve(dp_1.text,dp_2.text,ddlb_2.text, ls_ind)
...
integer width = 3131
integer height = 2056
string dataobject = "dw_gtelar029"
