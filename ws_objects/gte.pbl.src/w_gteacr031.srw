$PBExportHeader$w_gteacr031.srw
forward
global type w_gteacr031 from window
end type
type cb_3 from commandbutton within w_gteacr031
end type
type st_2 from statictext within w_gteacr031
end type
type ddlb_1 from dropdownlistbox within w_gteacr031
end type
type cb_2 from commandbutton within w_gteacr031
end type
type cb_1 from commandbutton within w_gteacr031
end type
type st_1 from statictext within w_gteacr031
end type
type dp_1 from datepicker within w_gteacr031
end type
type dw_1 from datawindow within w_gteacr031
end type
end forward
...
global w_gteacr031 w_gteacr031
...
datetime value = DateTime(Date("2023-09-14"), Time("12:08:30.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
integer width = 4485
integer height = 2088
string dataobject = "dw_gteacr031"
