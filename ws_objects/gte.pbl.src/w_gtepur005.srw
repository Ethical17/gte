$PBExportHeader$w_gtepur005.srw
forward
global type w_gtepur005 from window
end type
type ddlb_1 from dropdownlistbox within w_gtepur005
end type
type st_4 from statictext within w_gtepur005
end type
type rb_1 from radiobutton within w_gtepur005
end type
type rb_2 from radiobutton within w_gtepur005
end type
type dp_2 from datepicker within w_gtepur005
end type
type dp_1 from datepicker within w_gtepur005
end type
type st_2 from statictext within w_gtepur005
end type
type st_1 from statictext within w_gtepur005
end type
type cb_2 from commandbutton within w_gtepur005
end type
type cb_4 from commandbutton within w_gtepur005
end type
type gb_1 from groupbox within w_gtepur005
end type
type dw_1 from datawindow within w_gtepur005
end type
type dw_2 from datawindow within w_gtepur005
end type
end forward
...
string title = "(W_gtepur005) Local Purchase Detail"
...
global w_gtepur005 w_gtepur005
...
event clicked;if isnull(dp_1.text) or isnull(dp_2.text) or dp_1.text='00/00/0000' or dp_2.text = '00/00/0000' then
...
if rb_1.checked then
	...
	dw_2.retrieve(dp_1.text,dp_2.text,'0',ls_sup_id)
end if	
...
integer width = 3383
integer height = 1936
string dataobject = "dw_gtepur005"
boolean vscrollbar = true
end type
...
//	dw_1.hide()
	...
	dw_2.settransobject(sqlca)
	dw_2.retrieve(ls_frym,ls_toym,dw_1.getitemstring(row,'garden_inv_id'))	
end if
end event
...
integer width = 3639
integer height = 1936
string dataobject = "dw_gtepur005a"
boolean vscrollbar = true
end type
