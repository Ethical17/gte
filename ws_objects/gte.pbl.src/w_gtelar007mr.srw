$PBExportHeader$w_gtelar007mr.srw
forward
global type w_gtelar007mr from window
end type
type cbx_6 from checkbox within w_gtelar007mr
end type
type cbx_5 from checkbox within w_gtelar007mr
end type
type cbx_4 from checkbox within w_gtelar007mr
end type
type cbx_3 from checkbox within w_gtelar007mr
end type
type cbx_2 from checkbox within w_gtelar007mr
end type
type cbx_1 from checkbox within w_gtelar007mr
end type
type rb_1 from radiobutton within w_gtelar007mr
end type
type st_1 from statictext within w_gtelar007mr
end type
type cb_1 from commandbutton within w_gtelar007mr
end type
type cb_2 from commandbutton within w_gtelar007mr
end type
type st_2 from statictext within w_gtelar007mr
end type
type ddlb_1 from dropdownlistbox within w_gtelar007mr
end type
type ddlb_2 from dropdownlistbox within w_gtelar007mr
end type
type dw_1 from datawindow within w_gtelar007mr
end type
type dw_2 from datawindow within w_gtelar007mr
end type
end forward
...
string title = "(Gtelar007) - Wages Summary"
...
global w_gtelar007mr w_gtelar007mr
...
if rb_1.checked then
	...
	dw_2.retrieve(left(ddlb_1.text,10),ddlb_2.text,ls_temp,gs_garden_snm,gs_garden_state,ls_2000,ls_500,ls_100,ls_50,ls_20,ls_10)
	...
	dw_1.retrieve(left(ddlb_1.text,10),ddlb_2.text,ls_temp,gs_garden_snm,gs_garden_state,ls_2000,ls_500,ls_100,ls_50,ls_20,ls_10)
...
integer width = 5445
integer height = 2056
string dataobject = "dw_gtelar007_mr"
...
integer height = 2056
integer taborder = 30
string dataobject = "dw_gtelar007bmr"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
