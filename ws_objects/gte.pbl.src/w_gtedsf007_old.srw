$PBExportHeader$w_gtedsf007_old.srw
forward
global type w_gtedsf007_old from window
end type
type cb_10 from commandbutton within w_gtedsf007_old
end type
type cb_6 from commandbutton within w_gtedsf007_old
end type
type cb_5 from commandbutton within w_gtedsf007_old
end type
type cb_7 from commandbutton within w_gtedsf007_old
end type
type cb_8 from commandbutton within w_gtedsf007_old
end type
type cb_9 from commandbutton within w_gtedsf007_old
end type
type cb_4 from commandbutton within w_gtedsf007_old
end type
type cb_3 from commandbutton within w_gtedsf007_old
end type
type cb_2 from commandbutton within w_gtedsf007_old
end type
type cb_1 from commandbutton within w_gtedsf007_old
end type
type dw_1 from datawindow within w_gtedsf007_old
end type
type dw_2 from datawindow within w_gtedsf007_old
end type
end forward
...
global w_gtedsf007_old w_gtedsf007_old
...
string ls_bname, ls_badd, ls_cname, ls_cadd, ls_gradelist, ls_cnno, ls_cust, ls_brok,ls_lotno, ls_iss_locn, ls_rec_locn,ls_hsn_cd,ls_wareid
...
integer height = 1084
integer taborder = 30
string dataobject = "dw_gtedsf007_old"
end type
...
integer height = 1200
integer taborder = 40
string dataobject = "dw_gtedsf007a_old"
