$PBExportHeader$w_gtehrr031.srw
forward
global type w_gtehrr031 from window
end type
type st_4 from statictext within w_gtehrr031
end type
type em_2 from editmask within w_gtehrr031
end type
type st_3 from statictext within w_gtehrr031
end type
type ddlb_2 from dropdownlistbox within w_gtehrr031
end type
type rb_2 from radiobutton within w_gtehrr031
end type
type rb_1 from radiobutton within w_gtehrr031
end type
type em_1 from editmask within w_gtehrr031
end type
type ddlb_1 from dropdownlistbox within w_gtehrr031
end type
type st_1 from statictext within w_gtehrr031
end type
type cb_1 from commandbutton within w_gtehrr031
end type
type cb_2 from commandbutton within w_gtehrr031
end type
type st_2 from statictext within w_gtehrr031
end type
type gb_1 from groupbox within w_gtehrr031
end type
type dw_2 from datawindow within w_gtehrr031
end type
type dw_1 from datawindow within w_gtehrr031
end type
end forward
...
string title = "(Gtehrr031) - Payment Register"
...
global w_gtehrr031 w_gtehrr031
...
if rb_1.checked then
	dw_1.show()
	dw_2.hide()
	dw_1.retrieve(ls_division, ls_emp_type, em_1.text, em_2.text)
else
	dw_2.show()
	dw_1.hide()
	dw_2.retrieve(ls_division, ls_emp_type, em_1.text, em_2.text)
end if
...
integer height = 2104
string title = "none"
string dataobject = "dw_gtehrr031a"
...
integer height = 2104
string title = "none"
string dataobject = "dw_gtehrr031"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
