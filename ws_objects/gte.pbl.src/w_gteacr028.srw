$PBExportHeader$w_gteacr028.srw
forward
global type w_gteacr028 from window
end type
type em_2 from editmask within w_gteacr028
end type
type st_2 from statictext within w_gteacr028
end type
type em_1 from editmask within w_gteacr028
end type
type st_1 from statictext within w_gteacr028
end type
type cb_2 from commandbutton within w_gteacr028
end type
type cb_4 from commandbutton within w_gteacr028
end type
type dw_1 from datawindow within w_gteacr028
end type
end forward
...
global w_gteacr028 w_gteacr028
...
if  len(trim(em_2.text)) = 0 or isnull(em_2.text) then
	messagebox ('From date is blank','please Enter the Year Month')
	return 1
end if;
...
integer height = 2760
integer taborder = 50
string dataobject = "dw_gteacr028"
