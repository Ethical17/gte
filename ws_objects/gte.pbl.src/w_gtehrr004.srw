$PBExportHeader$w_gtehrr004.srw
forward
global type w_gtehrr004 from window
end type
type st_3 from statictext within w_gtehrr004
end type
type ddlb_2 from dropdownlistbox within w_gtehrr004
end type
type rb_2 from radiobutton within w_gtehrr004
end type
type rb_1 from radiobutton within w_gtehrr004
end type
type em_1 from editmask within w_gtehrr004
end type
type ddlb_1 from dropdownlistbox within w_gtehrr004
end type
type st_1 from statictext within w_gtehrr004
end type
type cb_1 from commandbutton within w_gtehrr004
end type
type cb_2 from commandbutton within w_gtehrr004
end type
type st_2 from statictext within w_gtehrr004
end type
type gb_1 from groupbox within w_gtehrr004
end type
type dw_2 from datawindow within w_gtehrr004
end type
type dw_1 from datawindow within w_gtehrr004
end type
end forward
...
global w_gtehrr004 w_gtehrr004
...
if rb_1.checked then
	...
	dw_2.show()
	dw_1.hide()
	dw_2.retrieve(ls_division,long(left(em_1.text,4)),long(right(em_1.text,2)),ls_emp_type)
end if
...
integer height = 2104
string title = "none"
string dataobject = "dw_gtehrr004a"
...
integer height = 2104
string title = "none"
string dataobject = "dw_gtehrr004"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
