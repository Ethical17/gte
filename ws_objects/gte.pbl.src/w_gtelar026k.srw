$PBExportHeader$w_gtelar026k.srw
forward
global type w_gtelar026k from window
end type
type ddlb_2 from dropdownlistbox within w_gtelar026k
end type
type st_5 from statictext within w_gtelar026k
end type
type em_1 from editmask within w_gtelar026k
end type
type st_4 from statictext within w_gtelar026k
end type
type ddlb_1 from dropdownlistbox within w_gtelar026k
end type
type st_2 from statictext within w_gtelar026k
end type
type dp_2 from datepicker within w_gtelar026k
end type
type st_1 from statictext within w_gtelar026k
end type
type dp_1 from datepicker within w_gtelar026k
end type
type st_3 from statictext within w_gtelar026k
end type
type cb_2 from commandbutton within w_gtelar026k
end type
type cb_1 from commandbutton within w_gtelar026k
end type
type dw_1 from datawindow within w_gtelar026k
end type
end forward
...
string title = "(Gtelar026) - Fortnightly/Weekly PF"
...
global w_gtelar026k w_gtelar026k

type variables
long ll_yrmn
string ls_temp,ls_gpf,ls_division
...
datetime value = DateTime(Date("2018-06-22"), Time("16:37:50.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
if gs_garden_state = '03' then
	dw_1.retrieve(dp_1.text,dp_2.text,ddlb_1.text,long(em_1.text), left(right(ddlb_2.text,11),10),ls_gapf)
else
	dw_1.retrieve(dp_1.text,dp_2.text,ddlb_1.text,long(em_1.text), ls_gapf,ls_gapf)
end if
...
integer width = 3625
integer height = 1884
string dataobject = "dw_gtelar026k"
