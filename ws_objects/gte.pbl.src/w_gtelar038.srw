$PBExportHeader$w_gtelar038.srw
forward
global type w_gtelar038 from window
end type
type st_1 from statictext within w_gtelar038
end type
type cb_1 from commandbutton within w_gtelar038
end type
type cb_2 from commandbutton within w_gtelar038
end type
type st_2 from statictext within w_gtelar038
end type
type ddlb_1 from dropdownlistbox within w_gtelar038
end type
type ddlb_2 from dropdownlistbox within w_gtelar038
end type
type dw_1 from datawindow within w_gtelar038
end type
end forward
...
string title = "(Gtelar005a) - Wages Pay Sheet"
...
global w_gtelar038 w_gtelar038
...
select distinct to_char(LWW_STARTDATE,'dd/mm/yyyy')||'-'||to_char(LWW_ENDDATE,'dd/mm/yyyy')||'-'||b.LWW_ID,LWW_STARTDATE
...
dw_1.retrieve(right(ddlb_1.text,13),ddlb_2.text)
...
integer width = 3269
integer height = 2372
string dataobject = "dw_gtelar038"
