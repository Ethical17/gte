$PBExportHeader$w_gtelar005mr_new.srw
forward
global type w_gtelar005mr_new from window
end type
type st_1 from statictext within w_gtelar005mr_new
end type
type cb_1 from commandbutton within w_gtelar005mr_new
end type
type cb_2 from commandbutton within w_gtelar005mr_new
end type
type st_2 from statictext within w_gtelar005mr_new
end type
type ddlb_1 from dropdownlistbox within w_gtelar005mr_new
end type
type ddlb_2 from dropdownlistbox within w_gtelar005mr_new
end type
type dw_1 from datawindow within w_gtelar005mr_new
end type
end forward
...
global w_gtelar005mr_new w_gtelar005mr_new
...
integer width = 4823
integer height = 2372
string dataobject = "dw_gtelar005mr_new"
