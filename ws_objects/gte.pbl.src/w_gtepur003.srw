$PBExportHeader$w_gtepur003.srw
forward
global type w_gtepur003 from window
end type
type ddlb_3 from dropdownlistbox within w_gtepur003
end type
type st_5 from statictext within w_gtepur003
end type
type ddlb_2 from dropdownlistbox within w_gtepur003
end type
type st_3 from statictext within w_gtepur003
end type
type ddlb_1 from dropdownlistbox within w_gtepur003
end type
type st_4 from statictext within w_gtepur003
end type
type dp_2 from datepicker within w_gtepur003
end type
type dp_1 from datepicker within w_gtepur003
end type
type st_2 from statictext within w_gtepur003
end type
type st_1 from statictext within w_gtepur003
end type
type rb_2 from radiobutton within w_gtepur003
end type
type rb_1 from radiobutton within w_gtepur003
end type
type cb_2 from commandbutton within w_gtepur003
end type
type cb_4 from commandbutton within w_gtepur003
end type
type gb_1 from groupbox within w_gtepur003
end type
type dw_2 from datawindow within w_gtepur003
end type
type dw_1 from datawindow within w_gtepur003
end type
end forward
...
string title = "(W_gtepur003) Purchase Invoice Detail"
...
global w_gtepur003 w_gtepur003
...
datetime value = DateTime(Date("2017-07-26"), Time("16:34:04.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
elseif rb_1.checked then
	...
	dw_2.retrieve(ls_frym,ls_toym,'A',ls_sup_id,ls_spc_id,ls_sp_id)	
end if
...
integer height = 1936
integer taborder = 50
string dataobject = "dw_gtepur003a"
boolean vscrollbar = true
end type
...
integer height = 1936
integer taborder = 60
string dataobject = "dw_gtepur003"
boolean vscrollbar = true
end type
