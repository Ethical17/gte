$PBExportHeader$w_gtelar007c_new.srw
forward
global type w_gtelar007c_new from window
end type
type rb_1 from radiobutton within w_gtelar007c_new
end type
type st_1 from statictext within w_gtelar007c_new
end type
type cb_1 from commandbutton within w_gtelar007c_new
end type
type cb_2 from commandbutton within w_gtelar007c_new
end type
type st_2 from statictext within w_gtelar007c_new
end type
type ddlb_1 from dropdownlistbox within w_gtelar007c_new
end type
type ddlb_2 from dropdownlistbox within w_gtelar007c_new
end type
type dw_2 from datawindow within w_gtelar007c_new
end type
type dw_1 from datawindow within w_gtelar007c_new
end type
end forward
...
global w_gtelar007c_new w_gtelar007c_new
...
integer height = 2056
integer taborder = 30
string dataobject = "dw_gtelar007d_new"
...
integer width = 4421
integer height = 2056
string dataobject = "dw_gtelar007c_new"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
