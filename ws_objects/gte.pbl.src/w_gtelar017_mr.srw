$PBExportHeader$w_gtelar017_mr.srw
forward
global type w_gtelar017_mr from window
end type
type rb_4 from radiobutton within w_gtelar017_mr
end type
type rb_3 from radiobutton within w_gtelar017_mr
end type
type rb_2 from radiobutton within w_gtelar017_mr
end type
type rb_1 from radiobutton within w_gtelar017_mr
end type
type st_1 from statictext within w_gtelar017_mr
end type
type ddlb_3 from dropdownlistbox within w_gtelar017_mr
end type
type ddlb_2 from dropdownlistbox within w_gtelar017_mr
end type
type ddlb_1 from dropdownlistbox within w_gtelar017_mr
end type
type cb_2 from commandbutton within w_gtelar017_mr
end type
type st_2 from statictext within w_gtelar017_mr
end type
type st_3 from statictext within w_gtelar017_mr
end type
type cb_1 from commandbutton within w_gtelar017_mr
end type
type gb_1 from groupbox within w_gtelar017_mr
end type
type dw_4 from datawindow within w_gtelar017_mr
end type
type dw_1 from datawindow within w_gtelar017_mr
end type
type dw_2 from datawindow within w_gtelar017_mr
end type
type dw_3 from datawindow within w_gtelar017_mr
end type
end forward
...
global w_gtelar017_mr w_gtelar017_mr
...
elseif rb_2.checked then
	...
	dw_3.hide()
	dw_4.hide()
	dw_2.retrieve(ddlb_1.text,left(ddlb_2.text,2),ddlb_3.text,gs_garden_snm)
...
elseif rb_3.checked then
	...
	dw_4.hide()
	dw_3.show()
	dw_3.retrieve(ddlb_1.text,left(ddlb_2.text,2),ddlb_3.text,gs_garden_snm)
...
elseif rb_4.checked then
	...
	dw_3.hide()
	dw_1.hide()
	dw_4.retrieve(ddlb_1.text,left(ddlb_2.text,2),ddlb_3.text,gs_garden_snm)
...
integer taborder = 50
string title = "none"
string dataobject = "dw_gtelar017bf_mr"
...
integer height = 2344
string title = "none"
string dataobject = "dw_gtelar017"
boolean hscrollbar = true
boolean vscrollbar = true
boolean resizable = true
boolean hsplitscroll = true
...
integer height = 2344
integer taborder = 40
string dataobject = "dw_gtelar017s"
boolean hscrollbar = true
boolean vscrollbar = true
boolean resizable = true
boolean hsplitscroll = true
