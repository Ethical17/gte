$PBExportHeader$w_gtebgr001.srw
forward
global type w_gtebgr001 from window
end type
type dw_1 from datawindow within w_gtebgr001
end type
type em_1 from editmask within w_gtebgr001
end type
type cb_2 from commandbutton within w_gtebgr001
end type
type st_1 from statictext within w_gtebgr001
end type
type cb_4 from commandbutton within w_gtebgr001
end type
end forward
...
string title = "(W_gtebgr001) Salary Budget"
...
global w_gtebgr001 w_gtebgr001
...
integer height = 2036
integer taborder = 60
string dataobject = "dw_gtebgr001"
