$PBExportHeader$w_gtepur011.srw
forward
global type w_gtepur011 from window
end type
type dp_1 from datepicker within w_gtepur011
end type
type dp_2 from datepicker within w_gtepur011
end type
type st_2 from statictext within w_gtepur011
end type
type st_1 from statictext within w_gtepur011
end type
type cb_2 from commandbutton within w_gtepur011
end type
type cb_4 from commandbutton within w_gtepur011
end type
type dw_1 from datawindow within w_gtepur011
end type
type dw_2 from datawindow within w_gtepur011
end type
end forward
...
global w_gtepur011 w_gtepur011
...
datetime value = DateTime(Date("2016-11-23"), Time("14:48:12.000000"))
integer textsize = -9
...
integer height = 1936
integer taborder = 50
string dataobject = "dw_gtepur011"
...
integer height = 1936
integer taborder = 60
string dataobject = "dw_gtepur011a"
boolean vscrollbar = true
end type
