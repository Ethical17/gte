$PBExportHeader$w_gtelar011.srw
forward
global type w_gtelar011 from window
end type
type dp_2 from datepicker within w_gtelar011
end type
type dp_1 from datepicker within w_gtelar011
end type
type st_3 from statictext within w_gtelar011
end type
type st_1 from statictext within w_gtelar011
end type
type cb_1 from commandbutton within w_gtelar011
end type
type cb_2 from commandbutton within w_gtelar011
end type
type st_2 from statictext within w_gtelar011
end type
type dw_1 from datawindow within w_gtelar011
end type
type ddlb_2 from dropdownlistbox within w_gtelar011
end type
end forward
...
string title = "(Gtelar011) - Attendance Summary"
...
global w_gtelar011 w_gtelar011
...
setpointer(hourglass!)
//FB_LABOURDAILYATTENDANCE 

ddlb_2.additem('ALL')

declare c2 cursor for
select distinct b.LS_ID from FB_LABOURDAILYATTENDANCE a,FB_EMPLOYEE b where a.LABOUR_ID = b.EMP_ID order by 1;
...
datetime value = DateTime(Date("2012-05-20"), Time("22:57:48.000000"))
integer textsize = -9
...
dw_1.retrieve(dp_1.text,dp_2.text,ddlb_2.text)
...
integer width = 3525
integer height = 2056
string dataobject = "dw_gtelar011"
