$PBExportHeader$w_gtelar010n.srw
forward
global type w_gtelar010n from window
end type
type st_2 from statictext within w_gtelar010n
end type
type ddlb_3 from dropdownlistbox within w_gtelar010n
end type
type rb_6 from radiobutton within w_gtelar010n
end type
type rb_5 from radiobutton within w_gtelar010n
end type
type rb_4 from radiobutton within w_gtelar010n
end type
type rb_3 from radiobutton within w_gtelar010n
end type
type st_3 from statictext within w_gtelar010n
end type
type st_1 from statictext within w_gtelar010n
end type
type cb_2 from commandbutton within w_gtelar010n
end type
type cb_1 from commandbutton within w_gtelar010n
end type
type ddlb_2 from dropdownlistbox within w_gtelar010n
end type
type ddlb_1 from dropdownlistbox within w_gtelar010n
end type
type gb_2 from groupbox within w_gtelar010n
end type
type gb_3 from groupbox within w_gtelar010n
end type
type rb_2 from radiobutton within w_gtelar010n
end type
type rb_1 from radiobutton within w_gtelar010n
end type
type gb_1 from groupbox within w_gtelar010n
end type
type dw_2 from datawindow within w_gtelar010n
end type
type dw_1 from datawindow within w_gtelar010n
end type
type dw_4 from datawindow within w_gtelar010n
end type
type dw_3 from datawindow within w_gtelar010n
end type
end forward
...
global w_gtelar010n w_gtelar010n
...
if ll_user_level<>0 then
	if rb_1.checked then
		dw_1.settransobject(sqlca)
		dw_1.retrieve(left(right(ddlb_1.text,15),14),long(left(ddlb_2.text,2)),ls_field_id,ll_user_level)	
	...
	elseif rb_2.checked then
		if rb_3.checked then
			dw_2.settransobject(sqlca)
			dw_2.retrieve(left(right(ddlb_1.text,15),14),long(left(ddlb_2.text,2)),ls_field_id,ll_user_level)
		...
		elseif rb_4.checked then
			dw_3.settransobject(sqlca)
			dw_3.retrieve(left(right(ddlb_1.text,15),14),long(left(ddlb_2.text,2)),ls_field_id,ll_user_level)
	...
	elseif rb_5.checked then
			dw_4.settransobject(sqlca)
			dw_4.reset()
			dw_4.retrieve(left(right(ddlb_1.text,15),14),'MB',ll_user_level)
	...
	elseif rb_6.checked then
			dw_4.settransobject(sqlca)
			dw_4.reset()
			dw_4.retrieve(left(right(ddlb_1.text,15),14),'SU',ll_user_level)
			if dw_4.rowcount() = 0 then
				messagebox('Information!','No data Found !!!')
				return 1
			end if	
...
integer height = 1924
integer taborder = 30
string dataobject = "dw_gtelar010bwn"
...
integer width = 3849
integer height = 1924
string dataobject = "dw_gtelar010n"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
...
integer height = 1924
integer taborder = 50
string dataobject = "dw_gtelar010dwn"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
...
integer height = 1924
integer taborder = 40
string dataobject = "dw_gtelar010cwn"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
