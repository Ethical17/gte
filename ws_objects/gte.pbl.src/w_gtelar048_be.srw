$PBExportHeader$w_gtelar048_be.srw
forward
global type w_gtelar048_be from window
end type
type ddlb_3 from dropdownlistbox within w_gtelar048_be
end type
type st_3 from statictext within w_gtelar048_be
end type
type ddlb_2 from dropdownlistbox within w_gtelar048_be
end type
type st_1 from statictext within w_gtelar048_be
end type
type cb_1 from commandbutton within w_gtelar048_be
end type
type cb_2 from commandbutton within w_gtelar048_be
end type
type st_2 from statictext within w_gtelar048_be
end type
type ddlb_1 from dropdownlistbox within w_gtelar048_be
end type
type dw_1 from datawindow within w_gtelar048_be
end type
end forward
...
global w_gtelar048_be w_gtelar048_be
...
dw_1.retrieve(ls_fr_dt,ls_bank,gs_garden_snm,long(ddlb_3.text))
...
integer width = 4398
integer height = 2276
string dataobject = "dw_gtelar048_be"
