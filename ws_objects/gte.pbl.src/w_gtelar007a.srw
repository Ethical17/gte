$PBExportHeader$w_gtelar007a.srw
forward
global type w_gtelar007a from window
end type
type st_1 from statictext within w_gtelar007a
end type
type cb_1 from commandbutton within w_gtelar007a
end type
type cb_2 from commandbutton within w_gtelar007a
end type
type st_2 from statictext within w_gtelar007a
end type
type ddlb_1 from dropdownlistbox within w_gtelar007a
end type
type ddlb_2 from dropdownlistbox within w_gtelar007a
end type
type dw_1 from datawindow within w_gtelar007a
end type
end forward
...
global w_gtelar007a w_gtelar007a
...
dw_1.retrieve(left(ddlb_1.text,10),ddlb_2.text)
...
integer width = 4293
integer height = 2372
string dataobject = "dw_gtelar007a"
