$PBExportHeader$w_gtepror001_mis.srw
forward
global type w_gtepror001_mis from window
end type
type st_2 from statictext within w_gtepror001_mis
end type
type dp_2 from datepicker within w_gtepror001_mis
end type
type dp_1 from datepicker within w_gtepror001_mis
end type
type rb_2 from radiobutton within w_gtepror001_mis
end type
type rb_1 from radiobutton within w_gtepror001_mis
end type
type st_1 from statictext within w_gtepror001_mis
end type
type cb_1 from commandbutton within w_gtepror001_mis
end type
type cb_2 from commandbutton within w_gtepror001_mis
end type
type dw_1 from datawindow within w_gtepror001_mis
end type
type gb_1 from groupbox within w_gtepror001_mis
end type
end forward
...
global w_gtepror001_mis w_gtepror001_mis
...
ls_text = "CREATE OR REPLACE VIEW FBVW_DMR (PARTICULARS, GTTYPE, NAME, PLUCKINGDATE, QUANTITY) AS  "&
		 ...
		 + " UNION ALL  "&
		 + " SELECT 'FUEL CONSUMPTION/KG OF MADE TEA', 'ALL', UPPER (ct.ct_manid), ddp.DDP_STARTRUNTIME, NVL(SUM(ddc.ddc_unitconsumed), 0) "&
...
datetime value = DateTime(Date("2016-03-01"), Time("12:43:51.000000"))
integer textsize = -9
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = roman!
...
integer width = 3387
integer height = 2028
string dataobject = "dw_gtepror001_mis"
