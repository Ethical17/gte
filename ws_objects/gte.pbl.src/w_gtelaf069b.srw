$PBExportHeader$w_gtelaf069b.srw
forward
global type w_gtelaf069b from window
end type
type cb_2 from commandbutton within w_gtelaf069b
end type
type em_from from editmask within w_gtelaf069b
end type
type st_5 from statictext within w_gtelaf069b
end type
type st_1 from statictext within w_gtelaf069b
end type
type cb_1 from commandbutton within w_gtelaf069b
end type
type ddlb_1 from dropdownlistbox within w_gtelaf069b
end type
type dw_1 from datawindow within w_gtelaf069b
end type
end forward
...
string title = "(W_Gtelaf069b) Extra Time Details"
...
global w_gtelaf069b w_gtelaf069b
...
event close;execute immediate "drop view ot_det_vw " using sqlca;
end event
...
elseif ddlb_1.text <> 'Two Hours' and ddlb_1.text <> 'More Than Two Hours'  and ddlb_1.text <> 'Essential Services' then
   ...
   m_frdt = LeftA(em_from.text,4)+RightA(em_from.text,2)
	...
	dw_1.settransobject(Sqlca)
	dw_1.retrieve(m_frdt,m_slip_type,'')
end if	
end event
...
integer width = 4878
integer height = 2044
string dataobject = "dw_Gtelaf069b"
