$PBExportHeader$w_gtelicf001.srw
forward
global type w_gtelicf001 from window
end type
type cb_4 from commandbutton within w_gtelicf001
end type
type cb_3 from commandbutton within w_gtelicf001
end type
type cb_2 from commandbutton within w_gtelicf001
end type
type cb_1 from commandbutton within w_gtelicf001
end type
type dw_1 from datawindow within w_gtelicf001
end type
end forward
...
global w_gtelicf001 w_gtelicf001
...
IF (isnull(dw_1.getitemstring(dw_1.rowcount(),'ld_licenseno')) or isnull(dw_1.getitemstring(dw_1.rowcount(),'ld_exp_dt'))) THEN
...
if cb_2.text = "&Query" then
	...
	dw_1.SetRedraw (TRUE)
	dw_1.settaborder('ld_particular',5)
	cb_2.text = "&Query"
	cb_1.enabled = true
end if
...
if dw_1.rowcount() = 0 then
	...
	dw_1.setitem(dw_1.getrow(),'ld_issue_dt',datetime(today()))
	dw_1.setcolumn('ld_particular')
else
	IF wf_check_fillcol(dw_1.getrow()) = -1 THEN
		return 1
...
integer height = 2052
integer taborder = 30
string dataobject = "dw_gtelicf001"
