$PBExportHeader$w_gtelar048_fb.srw
forward
global type w_gtelar048_fb from window
end type
type st_1 from statictext within w_gtelar048_fb
end type
type cb_1 from commandbutton within w_gtelar048_fb
end type
type cb_2 from commandbutton within w_gtelar048_fb
end type
type st_2 from statictext within w_gtelar048_fb
end type
type ddlb_1 from dropdownlistbox within w_gtelar048_fb
end type
type ddlb_2 from dropdownlistbox within w_gtelar048_fb
end type
type dw_1 from datawindow within w_gtelar048_fb
end type
end forward
...
global w_gtelar048_fb w_gtelar048_fb

type variables
long ll_pbno
string ls_temp, ls_dt,ls_labid,ls_measure,ls_measure1,ls_first_read,ls_old_labour, ls_type
datetime ld_dt
...
ls_type = right(ddlb_2.text,2)


dw_1.retrieve(ls_fr_dt,ls_type,gs_garden_snm,gs_garden_state)
...
boolean sorted = false
boolean vscrollbar = true
string item[] = {"Parmanent - LP","Temporary - LT","Outsider - LO"}
end type
...
integer width = 3826
integer height = 2372
string dataobject = "dw_gtelar048_fb"
