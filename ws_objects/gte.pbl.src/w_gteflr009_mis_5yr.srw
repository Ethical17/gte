$PBExportHeader$w_gteflr009_mis_5yr.srw
forward
global type w_gteflr009_mis_5yr from window
end type
type dp_2 from datepicker within w_gteflr009_mis_5yr
end type
type st_2 from statictext within w_gteflr009_mis_5yr
end type
type dp_1 from datepicker within w_gteflr009_mis_5yr
end type
type st_1 from statictext within w_gteflr009_mis_5yr
end type
type cb_2 from commandbutton within w_gteflr009_mis_5yr
end type
type cb_1 from commandbutton within w_gteflr009_mis_5yr
end type
type dw_1 from datawindow within w_gteflr009_mis_5yr
end type
end forward
...
global w_gteflr009_mis_5yr w_gteflr009_mis_5yr
...
on w_gteflr009_mis_5yr.destroy
destroy(this.dp_2)
destroy(this.st_2)
destroy(this.dp_1)
destroy(this.st_1)
...
datetime value = DateTime(Date("2017-05-12"), Time("10:24:07.000000"))
integer textsize = -9
...
integer width = 4466
integer height = 2240
string dataobject = "dw_gteflr009_mis_5yr"
